"""
Django settings for captain_backend project.
...
SECRET_KEY = 'django-insecure-ut(*g5ski^pswils6evt-@hil5$i-3fon%^-fkc-1qui#&!0il'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'captain_citizen',
        'USER': 'captain_user',
        'PASSWORD': 'captain_citizen',
        'HOST': 'localhost'
    }
}
